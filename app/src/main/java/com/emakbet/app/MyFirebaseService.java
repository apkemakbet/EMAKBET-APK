...
public class MyFirebaseService extends FirebaseMessagingService {
    ...
    private static final String CHANNEL = "emakbet_promo";

    /* ---- Notif masuk (app ketutup pun tetap kena) ---- */
    @Override
    public void onMessageReceived(@NonNull RemoteMessage msg) {
        String title = "EMAKBET";
        String body = "";
        String clickUrl = "";
        String image = "";
    ...
    public void onNewToken(@NonNull String token) {
        ...
        SharedPreferences sp = getSharedPreferences("emakbet_pref", Context.MODE_PRIVATE);
    ...
    private void show(String title, String body, String clickUrl, String imageUrl) {
        ...
        // Logo EMAKBET WARNA khusus notif (PNG murni) -> muncul di kanan tiap notif.
